          ...
          children: [
            ...
            Expanded(
              child: Column(
                ...
                children: [
                  Text(
                    session.deviceName ?? session.ipAddress,
                    style: const TextStyle(fontWeight: FontWeight.w600),
                  ),
                  Text(
                    '${session.ipAddress} · ${session.controlStatus.label} · RTT ${session.roundTripTimeMicros ~/ 1000} ms · offset ${session.clockOffsetMicros ~/ 1000} ms · drift ${session.clockDriftPpm} ppm',
                    style: Theme.of(context).textTheme.bodySmall,
                  ),
                  const SizedBox(height: 8),
                  Row(
